<%@ Page Title="" Language="C#" MasterPageFile="~/DashBoardMaster.Master" AutoEventWireup="true" CodeBehind="CreateIngredientDashBoard.aspx.cs" Inherits="Recipe.CreateIngredientDashBoard" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    
        
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom" >
        <h1 class="h2">Criar Ingrediente</h1>
    ...
    <%
        if(IsPostBack)
        {
            ...
            {
                if (Recipe.DAL.Ingredient.CreateIngredient(Name.Value))
                {
                    Response.Redirect("DashBoard.aspx/ingredients");
                }
                else
                {
    ...
    <main class="my-4 col-md-12 col-lg-12 aligncenter px-1">
        <h2 class="mb-3">Dados do Ingrediente</h2>
